...
extern int config_MAX_OMEM;
extern int free_memory;
extern int pages_paged_in;
extern int pages_paged_out;
...
void displayHelp() {
    ...
    printf("  vmstat           - Display memory and CPU statistics\n");
    printf("  process-smi      - Memory, paging, and process details\n");
...
void displayMainMenuProcessSMI() {
    ...
    int memory_utilization = (used_memory * 100) / config_MAX_OMEM;
    SetConsoleTextAttribute(hConsole, 11);
    printf("Memory Usage: %dMiB / %dMiB\n", used_memory / 1024, config_MAX_OMEM / 1024);
